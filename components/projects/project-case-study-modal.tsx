  ...
  return (
    ...
    >
      ...
      <div className="relative w-full max-w-4xl max-h-[90vh] overflow-y-auto rounded-2xl glass-panel border border-white/10 bg-[#09090b]/95 p-5 sm:p-8 text-left space-y-6 shadow-2xl">
        {/* Top Header Actions: GitHub Quick Link & Close Button */}
        <div className="absolute top-5 right-5 flex items-center gap-2">
          {project.githubUrl && (
            <a
              ...
              className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-xl bg-white/5 border border-white/10 text-xs font-mono text-zinc-300 hover:text-white hover:bg-white/10 transition-all focus:outline-none focus:ring-2 focus:ring-sky-400"
          ...
          <button
            ...
            className="p-2 rounded-xl bg-white/5 border border-white/10 text-zinc-400 hover:text-white hover:bg-white/10 transition-all focus:outline-none focus:ring-2 focus:ring-sky-400"
          >
            <X className="w-5 h-5" />
          </button>
        </div>
        ...
        {/* Modal Header */}
        <div className="space-y-2 border-b border-white/10 pb-5 pr-28 sm:pr-36">
        ...
        >
          ...
          >
            ...
            <span
              className={`px-1.5 py-0.5 rounded text-[9px] font-mono uppercase font-extrabold ${
                activeTab === 'demo'
